...
const ProblemStatement = () => {
    ...
    return (
        <section
            className={"problem-statement-section flex flex-col items-center justify-start mx-auto"}>
            ...
            <div className={"flex-col items-center justify-center text-center"}>
                ...
                <p className={"problem-statement-subheading text-sm mt-4 text-gray-500 italic max-w-2xl"}>
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-2 h-96 ">
                <CardSpotlight className="problem-statement-card h-full space-y-6">
                    ...
                    <p className="text-neutral-300 mt-4 relative z-20 text-sm">
                        87% of professionals feel their skills will become outdated within 2 years, making continuous
                        learning a necessity, not a choice.
                    </p>
                </CardSpotlight>
                <CardSpotlight className="problem-statement-card h-full space-y-6">
                    <div className={"flex items-center justify-center p-2"}>
                    ...
                    <p className="text-neutral-300 mt-4 relative z-20 text-sm">
                        Organizations are struggling to find candidates with the current, relevant skills needed to keep
                        pace with evolving technologies and market demands.
                    </p>
                </CardSpotlight>
                <CardSpotlight className="problem-statement-card h-full space-y-6">
                    <div className={"flex items-center justify-center p-2"}>
                    ...
                    <p className="text-xl font-bold relative z-20 mt-2 text-white">
                        Learning Platforms Are Falling Behind</p>

                    <p className="text-neutral-300 mt-4 relative z-20 text-sm">
                        Traditional education systems and online platforms often fail to keep up with industry shifts,
                        leaving learners unprepared for real-world challenges.
                    </p>
                </CardSpotlight>
                <CardSpotlight className="problem-statement-card h-full space-y-6">
                    <div className={"flex items-center justify-center p-2"}>
                    ...
                    <p className="text-xl font-bold relative z-20 mt-2 text-white">
                        One-Size-Fits-All Advice Doesn’t Work </p>

                    <p className="text-neutral-300 mt-4 relative z-20 text-sm">
                        Generic career advice ignores your personal journey, goals, and experience—leading to misaligned
