...
import {AuthImage, AuthNature, AuthSideImage, FoxIcon} from "@/app/static/static";
...
const Login = () => {
    ...
    return (
        <section className={"auth-page overflow-hidden"}>
            ...
            {/*Right Side*/}
            <div
                className={"relative flex-1 rounded-tr-2xl rounded-br-2xl flex flex-col items-center justify-center gap-8 bg-[#fffbeb]"}>
